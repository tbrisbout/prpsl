...
var $author$project$Main$clean = A2(
...
var $author$project$Main$toStyle = function (l) {
...
var $author$project$Main$css = A2(
	$elm$core$Basics$composeR,
	...
	$elm$core$List$map(
		A2(
			...
			A2(
				$elm$core$Basics$composeR,
				$elm$core$List$map($author$project$Main$clean),
	...
	return A3(
		...
		F2(
			function (_v0, acc) {
				var _char = _v0.a;
				var code = _v0.b;
				return A3($elm$core$String$replace, _char, code, acc);
			}),
		str,
		$author$project$Main$charHexMap);
};
...
var $author$project$Main$view = function (model) {
	return A2(
		$elm$html$Html$div,
		$author$project$Main$mainStyles,
		_List_fromArray(
			[
				A2(
				$elm$html$Html$h1,
